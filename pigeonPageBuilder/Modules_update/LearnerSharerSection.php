...
?>
                                        <div class="dot <?php if ($f === 0) { echo " active"; } ?>" onclick="handleCarouselFrameChange(event)" index="<?php echo $f; ?>"></div>
<?php
                                    }
?>
                                </div>
...
?>
                                        <div class="dot <?php if ($e === 0) { echo " active"; } ?>" onclick="handleCarouselFrameChange(event)" index="<?php echo $e; ?>"></div>
<?php
                                    }
?>
                                </div>
