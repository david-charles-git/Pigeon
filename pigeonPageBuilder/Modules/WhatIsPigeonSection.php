...
?>
<section id="whatIsPigeon" class="wipSection <?php if ($hasCustomClass) {
                                                    echo $customClass;
                                                } ?>">
    <div class="wipSection_outer">
        <div class="wipSection_inner">
            ...
            <div class='video_container wipVideo' playPause='play'>
                ...
                if ($video_thumbnail) {
                ?>
                    <div class='video_thumbnail' style='background-image: url(<?php echo $video_thumbnail; ?>); <?php if (!$video) {
                                                                                                                    echo "position: relative; aspect-ratio: 16 / 9;";
                                                                                                                } ?>'></div>
                <?php
                }
