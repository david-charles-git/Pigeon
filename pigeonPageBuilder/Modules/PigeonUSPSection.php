...
?>
<section class="uspSection <?php if ($hasCustomClass) {
                                echo $customClass;
                            } ?>">
    <div class="uspSection_outer">
        ...
        <div class="uspContainer">
            <div class="uspContainerInner" ontouchstart="updateUspTouchX(event)" ontouchend="shiftUspByTouch(event)" ontouchcancel="shiftUspByTouch(event)">
                <div class="uspItem">
                ...
                <div class="uspItem">
                    <div class="uspItemInner">
                        <div class="icon imageContainer">
                            <img src="<?php echo get_stylesheet_directory_uri() .  "/pigeonImages/PGN_Screen_Icon.svg"; ?>" />
                        </div>
