...
?>
    ...
    <html <?php language_attributes(); ?> >
        <head>
            ...
            <link rel='stylesheet' type='text/css' href='<?php echo get_stylesheet_directory_uri(); ?>/CSS/pigeonCSS.css?=v3.9' />
                ...
                <nav id="mainNavigation" class="mainNavigation">
                    <div class="mainNavigation_inner">
                        ...
                        <div class="mainNavigation_center imageContainer">
                            <a href="#">
                                <img src="<?php echo "https://" . $_SERVER['HTTP_HOST'] . "/wp-content/themes/Pigeon/pigeonImages/PGN_Logo.png"; ?>" />
                            </a>
                        </div>
