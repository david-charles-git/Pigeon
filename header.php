...
<html <?php language_attributes(); ?> >
    <head>
        ...
        <link rel='stylesheet' type='text/css' href='<?php echo get_stylesheet_directory_uri(); ?>/CSS/master_CSS.css?=v3.9' />
        <script src='<?php echo get_stylesheet_directory_uri(); ?>/JS/master_JS.js?=v3.9'></script>
...
?>
    ...
    <body>
        <!-- Google Tag Manager (noscript) -->
            <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T2T39VZ&gtm_auth=VS_xHfyrfVNa9hr0zrxazw&gtm_preview=env-1&gtm_cookies_win=x"
